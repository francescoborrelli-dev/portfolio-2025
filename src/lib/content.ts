...
export const mockProjects: Project[] = [
  ...
  },
  {
    ...
    description: 'Progettazione di un\'app mobile innovativa che ridefinisce l\'esperienza utente nel settore fintech.',
    role: 'UI/UX Designer',
    year: '2024',
    stack: ['Figma', 'Principle', 'React Native', 'TypeScript'],
    url: '/projects/mobile-app-design',
    body: {
      raw: 'Detailed project content...',
      code: '<h1>Project Details</h1>',
    },
